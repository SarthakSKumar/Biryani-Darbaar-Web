      ...
      >
        ...
        <section className="container-custom text-center section-spacing">
          ...
          >
            ...
            <span className="text-sm font-semibold text-primary">Last Updated: {privacyPolicyMeta.lastUpdated}</span>
          </motion.div>
              ...
              {section.subsections ? (
                <div className="flex items-start gap-4 mb-4">
                  <div className="flex-1">
                    <h3 className="text-xl md:texl-2xl font-semibold text-neutral-900 mb-4">
                      {section.title}
                    </h3>
                    <div className="space-y-4 text-lg text-neutral-600 leading-relaxed">
                      ...
                      <div className="pl-4 border-l-4 border-primary/30">
                        {section.subsections.map((subsection, subIndex) => (
                          <p key={subIndex} className={subIndex < section.subsections!.length - 1 ? "mb-3" : ""}>
                            <strong className="text-neutral-900">{subsection.label}:</strong> {subsection.text}
                          </p>
                        ))}
                      </div>
                    </div>
