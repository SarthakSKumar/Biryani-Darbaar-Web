            ...
            <div className="container-custom">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="hidden md:block md:w-2/5">
                        <img src={homechef1} alt="Chef" className="w-full h-auto" />
                    </div>
