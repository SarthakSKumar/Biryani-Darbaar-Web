  ...
  return (
    <>
      ...
      <div className="tso md:mt-24 text-center">
        <h1 className="text-4xl font-bold dp3:text-6xl">Today  <span className="text-red-500">special</span> offers</h1>
        <p className="mt-6 lg:ml-10 lg:mr-10 dp3:text-3xl">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
